...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i13.GetTransactionStatusUseCase>(() =>
        _i13.GetTransactionStatusUseCase(
            transactionRepository: gh<_i7.TransactionRepository>()));
    gh.lazySingleton<_i14.TransactionService>(() => _i15.TransactionServiceImpl(
        getTransactionStatusUseCase: gh<_i13.GetTransactionStatusUseCase>()));
    gh.lazySingleton<_i16.WalletBalanceUsecase>(() => _i16.WalletBalanceUsecase(
        walletRepository: gh<_i10.WalletRepository>()));
    gh.lazySingleton<_i17.WalletHistoryUsecase>(() => _i17.WalletHistoryUsecase(
        walletRepository: gh<_i10.WalletRepository>()));
    gh.lazySingleton<_i18.WalletService>(() => _i19.WalletServiceImpl(
          walletUsecase: gh<_i12.WalletUsecase>(),
          historyUsecase: gh<_i17.WalletHistoryUsecase>(),
          balanceUsecase: gh<_i16.WalletBalanceUsecase>(),
        ));
    return this;
  }
}
